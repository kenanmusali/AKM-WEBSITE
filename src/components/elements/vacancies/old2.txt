...
const Vacancies = () => {
    ...
    if (isLoading) {
        return <div className="section-column "><div className="Snackbar-Style"><img src={ArrayData0Svg} /><p>Vakansiyalar Yüklənir...</p></div> </div>;
    }
                                        ...
                                        {/* <div className="job-description">
                                            <p style={{ whiteSpace: 'pre-line' }}>
                                                {jobDescriptions[selectedJob.id]?.split('\n').map((line, index) => {
                                                    ...
                                                    if (upperCaseLine.startsWith('ÜMUMİ VƏZİFƏ ÖHDƏLİKLƏRİ:') ||
                                                        upperCaseLine.startsWith('NAMİZƏDƏ QARŞI TƏLƏBLƏR:') ||
                                                        upperCaseLine.startsWith('PEŞƏKARLIK BACARIQLARI:')) {
                                                        return (
